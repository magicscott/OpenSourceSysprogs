...
//*
//
ADDUSER ZCXADM1 PASSWORD(password) NAME('zCX Admin User 1') +
OWNER(SYS1) +
UACC(ALTER) DFLTGRP(ZCXADMG) AUTHORITY(JOIN) GRPACC TSO(ACCTNUM(ACCT#) +
PROC(PROC394) SIZE(2096128) MAXSIZE(0) UNIT(SYSALLDA) +
